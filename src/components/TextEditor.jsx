  ...
  return (
    ...
    >
      ...
      >
        ...
        <p className="text-my_orange">Done</p>
      </div>
      {/* share div */}
      <div
      ...
      >
        ...
        <p className="text-mid_grey text-sm mt-2">Easily send links to potential buyer</p>
        <h4 className="text-lg text-my_black4 font-bold mt-3">Link to description</h4>
        <div className="relative">
          ...
          />
          <button className="py-2 px-3 bg-my_orange font-semibold rounded-lg absolute right-1 top-1/2 -translate-y-1/2">Copy</button>
        </div>
      </div>
